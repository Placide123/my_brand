    ...
    <div className="p-7 m-10 border-2 border-lime-300">
      ...
      <div className="flex justify-between flex-wrap">
        <div className="w-full sm:w-auto md:w-1/3 p-3">
          <img src={Design} alt="design" className="h-1/2 w-full" />
          <h1 className="font-bold text-lime-400 mt-2">Web Design</h1>
          <p>
        ...
        <div className="w-full sm:w-auto md:w-1/3 p-3">
          <img src={website} alt="website" className="h-1/2 w-full" />
          <h1 className="font-bold text-lime-400 mt-2">Website development</h1>
          <p>
        ...
        <div className="w-full sm:w-auto md:w-1/3 p-3">
          <img src={Mobile} alt="Mobile" className="h-1/2 w-full" />
          <h1 className="font-bold text-lime-400 mt-2">Mobile development</h1>
          <p>
