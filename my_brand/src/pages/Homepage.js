...
export default function Homepage() {
  return (
    <div className="flex flex-col-reverse m-2 md:flex-row  md:m-10 h-[90vh] ">
      <div className="flex flex-col justify-center items-center md:items-start md:w-1/2">
        <h1 className="text-xl md:text-5xl font-bold md:ml-48 md:mb-4 ml-0 p-2">
         <span className="text-primary"> Hi, I'm Placide</span>
           TWIRINGIYIMANA.
        </h1>
        <p className=" flex md:ml-48 text-base lg:text-xl font-serif md:mb-4 p-2 w-11/12 justify-center items-center ">
        ...
        <button className="md:ml-48 p-2 md:p-2 bg-primary font-bold rounded md:w-1/5 text-gray-100 text-xl w-full flex justify-center">Let's talk</button>
      </div>
      <div className="flex justify-center items-center md:justify-center md:items-center md:w-10/12">
        <img src={Placide} alt="bio" className="object-contain w-10/12 h-[40vh]  rounded md:rounded-full md:object-contain md:h-[60%] border-primary border-4 border-none" />
      </div>
    </div>
  );
} 
