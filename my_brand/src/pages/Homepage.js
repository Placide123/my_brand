...
export default function Homepage() {
  return (
    <div className="flex flex-col-reverse lg:flex-row p-7 m-10 border-2 border-lime-300">
      <div className="flex flex-col justify-center lg:mr-20 lg:w-1/2">
        <h1 className="text-4xl lg:text-7xl font-bold p-4 mt-2">
          Hi, I'm Placide <br />
          TWIRINGIYIMANA.
        </h1>
        <p className="p-8 font-sans text-lg lg:text-xl">
        ...
        <button className="ml-8 p-2 bg-lime-400 font-bold rounded">Let's talk</button>
      </div>
      <div className="flex justify-center lg:w-1/2">
        <img src={Placide} alt="bio" className="object-cover h-3/4 w-3/5 lg:rounded-full lg:object-contain lg:h-full" />
      </div>
    </div>
  );
}
