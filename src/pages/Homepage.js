...
export default function Homepage() {
  return (
    <div className="flex flex-col-reverse m-2 md:flex-row md:m-6 lg:m-8 xl:m-9 h-[100vh] md:h-[90vh] lg:w-[90%]">
      <div className="flex flex-col justify-center items-center md:ml-12 xl:ml-32 md:items-start md:w-1/2 xl:w-3/5 hover:animate-pulse">
        ...
        <p className=" flex  text-base lg:text-xl font-serif md:mb-4 p-2 w-[95%] justify-center items-center text-justify ">
